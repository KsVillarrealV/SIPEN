...
<input class="form-control me-2 w-25" id="FiltrarContenido"  type="text" class="form-control" placeholder="Buscar" aria-label="Alumno" aria-describedby="basic-addon1">
      <button type="button" class="btn bg-white h-25 border" data-bs-toggle="modal" data-bs-target="#exampleModal1">
      <i class="fa-solid fa-file-pen"></i> Nuevo Edificio
</button>
</div>
...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <i class="fa-solid fa-face-laugh fa-6x"></i>
   <h2>Bienvenido a tu sistema de información</h1>
  </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Empezar</button>
      </div>
    </div>
  </div>
</div>
     ...
     require_once("../../model/agregar_edificio.php"); 
     require_once("../../model/eliminar_edificio.php"); 
     require_once("../../model/modificar_edificio.php"); 
...
<div class="modal-dialog modal-dialog-centered">
   ...
   <h2>Registro ya se encuentra</h2>
    ...
    <div id="container">
  <?php
include("../../controller/tabla_edificio.php");
?> 
</div>
...
<style>
  ...
  background: url(assets/img/edificio.png)no-repeat center center fixed;
