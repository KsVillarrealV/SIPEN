...
<input class="form-control me-2 w-25" id="FiltrarContenido"  type="text" class="form-control" placeholder="Buscar" aria-label="Alumno" aria-describedby="basic-addon1">
      <button type="button" class="btn bg-white h-25 border " data-bs-toggle="modal" data-bs-target="#exampleModal4">
      <i class="fa-solid fa-file-pen"></i> Nuevo Proveedor
</button>
</div>
...
<div class="modal-dialog modal-dialog-centered">
   ...
   <?php require_once("../../model/agregar_proveedor.php"); ?> 
   <?php require_once("../../model/eliminar_proveedor.php"); ?> 
   <?php require_once("../../model/modificar_proveedor.php"); 
   if (isset($_GET['i'])){$i= $_GET['i'];};?> 

   
<div id="container">
  <?php
include("../../controller/tabla_proveedor.php");
?> 
<script>
...
<style>
  ...
  background: url(assets/img/proveedor.png) no-repeat center center fixed;
